        ...
        <div className="bg-gray-800 p-6 rounded-lg shadow-md space-y-6">
            ...
            {questions[currentQuestionIndex].answers.map((answer, index) => {
              ...
              return questions[currentQuestionIndex].multipleAnswers ? (
                <li
                  ...
                  className={`p-3 rounded-3xl cursor-pointer ${answerClass} ${isAnswerChecked ? isAnswerCheckedClass : ''}`}
                >
                  <input
                    type="checkbox"
                    checked={isSelected}
          ...
          {!isAnswerChecked && (
            <button
              ...
              className="bg-teal-500 text-white p-3 rounded-3xl w-full mt-6 transition-colors"
